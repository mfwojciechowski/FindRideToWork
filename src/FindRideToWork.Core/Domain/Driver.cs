...
namespace FindRideToWork.Core.Domain
{
    ...
    {        
        ...
        public void AddRoute(string routeName, RoutePoint startPoint, RoutePoint endPoint)
        {
            if(GetRoute(routeName) != null)
            {
                throw new Exception("Route for driver exists");
            }
            _route.Add(Route.Create(routeName, startPoint, endPoint));
        }
        ...
        public void AddVehicle(Vehicle vehicle)
        {
            ...
            _vehicles.Add(Vehicle.Create(vehicle.Brand, vehicle.SeatsNumber, vehicle.Doors, vehicle.Plates, vehicle.CarModel));
        }
